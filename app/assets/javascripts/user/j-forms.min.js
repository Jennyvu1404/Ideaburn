$(document).ready(function(){$("#phone").mask("(+99) 99999-99999",{placeholder:"x"}),$("#post").mask("999-9999",{placeholder:"x"}),$("#j-forms").validate({errorClass:"error-view",validClass:"success-view",errorElement:"span",onkeyup:!1,onclick:!1,rules:{first_name:{
required:!0
}
,last_name:{
required:!0
...
,file1:{
required:!0,extension:"doc|docx|xls|xlsx"
}
,file2:{
required:!0,extension:"doc|docx|xls|xlsx"
}
...
,email:{
required:"Please enter your email",email:"Incorrect email format"
}
...
,file1:{
required:"Please upload some file",extension:"Incorrect file format"
}
,file2:{
required:"Please upload some file",extension:"Incorrect file format"
}
...
var e=$(this).attr("id"),s=$("#"+e+" fieldset").length,t=$("#"+e+" .step").length,i=$("#"+e+" .multi-next-btn"),r=$("#"+e+" .multi-prev-btn"),a=$("#"+e+" .multi-submit-btn");$("#"+e+" fieldset").eq(0).addClass("active-fieldset"),t&&$("#"+e+" .step").eq(0).addClass("active-step"),$("#"+e+" fieldset").eq(0).hasClass("active-fieldset")&&(a.css("display","none"),r.css("display","none")),i.on("click",function(){
